...
#####Data Transformation
1. The sets of test (x-test.txt)  and training (y-test.txt) were read using the _read.table_ command from the  _data.table_ R package, both sets were merge in a large data.frame (_rbind command_). Variables' names for this large data (10,299*561) set were obtained from the file features.txt.
